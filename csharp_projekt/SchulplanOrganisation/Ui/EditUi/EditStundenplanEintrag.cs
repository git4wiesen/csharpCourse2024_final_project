...
{
    public partial class EditStundenplanEintrag : Form
    {
        ...
        private void EditKlasse_Load(object sender, EventArgs e)
        {
            ...
            cbSchultag.Items.Clear();
            cbZeitSlot.Items.Clear();
            cbSchultag.Items.AddRange(["", .. Schulzeit.GetSchultage().Select(t => t.Name()).ToArray()]);
            cbZeitSlot.Items.AddRange(["", .. Schulzeit.GetUnterrichtszeiten().Select(t => t.Name()).ToArray()]);

            cbSchultag.SelectedIndex = 0;
            cbZeitSlot.SelectedIndex = 0;
        }
        ...
        {
            ShowNotImplementedMessageBox(function: "EditStundenplanEintrag");
